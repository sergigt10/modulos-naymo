        ...
        <div class="row-fluid no-padd">
            <div class="col-sm-12 no-padd">
                <div class="container-fluid top-banner no-padd big enable_column light no-marg-bottom vindow-height">
                    ...
                    <img src="{{ asset('frontend/img/mobil-home-gama-media.webp') }}" class="s-img-switch" alt="Módulos Naymo">
                    <div class="content">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <picture>
                                        ...
                                        <img src='{{ asset("/storage/$gamaMedia->imatge1") }}' class="wp-post-image" alt="Módulos Naymo" />
                                    </picture>
                                </div>
                                @if( $gamaMedia->imatge2 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge2") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge3 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge3") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge4 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge4") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge5 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge5") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge6 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge6") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge7 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge7") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge8 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge8") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge9 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge9") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge10 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge10") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge11 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge11") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge12 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge12") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge13 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge13") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge14 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge14") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge15 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge15") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge16 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge16") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge17 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge17") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge18 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge18") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge19 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge19") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                                @if( $gamaMedia->imatge20 ) 
                                    <div class="item">
                                        <picture>
                                            ...
                                            @endphp
                                            <source srcset='{{ asset("/storage/$senseExtencio") }}.webp' type="image/webp">
                                            <img src='{{ asset("/storage/$gamaMedia->imatge20") }}' class="wp-post-image" alt="Módulos Naymo" />
                                        </picture>
                                    </div>
                                @endif
                            </div>
